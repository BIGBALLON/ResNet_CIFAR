...
parser.add_argument('-e','--epochs', type=int, default=200, required=True, metavar='NUMBER',
...
parser.add_argument('-s','--lr_scheduler', type=int, default=1, required=True, metavar='NUMBER',
                help='learning rate scheduler. [1, 2, 3] (default: 1 -> scheduler_200_81_122)')
...
def scheduler_200_100_150(epoch):
    if epoch < 100:
        return 0.1
    if epoch < 150:
        return 0.01
...
def scheduler_300_150_225(epoch):
    if epoch < 150:
        return 0.1
    if epoch < 225:
        return 0.01
...
if __name__ == '__main__':
    ...
    # visualize model if you need. 
    # from keras.utils import plot_model
    # plot_model(resnet, show_shapes=True, to_file='./model.png')
    ...
    if args.lr_scheduler == 1:
        ...
        cb_lr = LearningRateScheduler(scheduler_200_100_150)
    elif args.lr_scheduler == 3:
        cb_lr = LearningRateScheduler(scheduler_300_150_225)
    
    cb_tb = TensorBoard(log_dir='./resnet_{:d}_{}_{:d}/'.format(layers,args.dataset,args.lr_scheduler), histogram_freq=0)
    cbks = [cb_lr,cb_tb]
    ...
    resnet.save('resnet_{:d}_{}_{:d}.h5'.format(layers,args.dataset,args.lr_scheduler))
