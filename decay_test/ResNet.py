...
parser.add_argument('-s','--scheduler', type=int, default=1, metavar='NUMBER',
                help='learning rate scheduler. [1, 2, 3 or 4] (default: 1)')
...
def scheduler_200_125_170(epoch):
    if epoch < 125:
        return 0.1
    if epoch < 170:
        return 0.01
...
def scheduler_200_150_180(epoch):
    if epoch < 150:
        return 0.1
    if epoch < 180:
        return 0.01
...
if __name__ == '__main__':
    ...
    # set callback
    if scheduler == 1:
        lrs = LearningRateScheduler(scheduler_200_81_122)
    elif scheduler == 2:
        lrs = LearningRateScheduler(scheduler_200_100_150)
    elif scheduler == 3:
